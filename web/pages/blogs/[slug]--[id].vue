<template>
  <div class="flex flex-col gap-4">
        ...
        <main class="prose lg:prose-lg">
          ...
          <div class="post-tags text-mono f4-mktg mt-8">
            <div class="d-flex flex-nowrap flex-items-start">
              <span class="post-tags-label flex-shrink-0 d-inline-block mt-2">Tags:</span> <ul class="d-inline-block list-style-none color-text-link mb-0">
    ...
    <section class="flex flex-col gap-8 px-4 lg:px-20 py-8 lg:py-12">
      ...
      <ul class="hidden lg:flex justify-center gap-4">
        <li
          v-for="el in relatedBlogs.slice(0, 4)"
          :key="el.id"
        >
          <article class="blog-card">
            <NuxtLink
              :title="el.title"
              :to="{name: 'blogs-slug--id', params: {slug: el.slug, id: el.id}}"
            ...
            <div class="subtitle">
              ...
              <time class="">{{ el.createdAt.toLocaleDateString() }}</time>
            </div>
          </article>
        </li>
      </ul>
...
import { ClipboardCopyIcon, ShareIcon } from '@heroicons/vue/solid';
...
const blog = {
  ...
  featuredImgUrl: 'https://picsum.photos/800/600',
  createdAt: new Date(),
